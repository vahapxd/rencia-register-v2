...
let embed = new MessageEmbed().setColor("RANDOM").setAuthor(member.guild.name, member.guild.iconURL({dynamic: true})).setFooter("Bubbles ❤️ " + member.guild.name).setTimestamp()
if(security === "şüpheli") {
...
\`>\` Sol taraftaki \`<#965716655546175549>\` kanallarından birine girip \`isim-yaş\` belirterek kayıt olabilirsin.`)
};
});
